...
INSERT INTO Containers (quantity, size, reservedPart, location, description, isEmpty, isReserved)
VALUES (2, 15, "ScrewA", "A1", "A1 container", FALSE, FALSE);

INSERT INTO Containers (quantity, size, location)
VALUES (2, 15, "A1");

INSERT INTO Containers (quantity, size, reservedPart, location, description, isEmpty, isReserved)
VALUES (1, 25, "ScrewAB", "A2", "A2 container", FALSE, FALSE);